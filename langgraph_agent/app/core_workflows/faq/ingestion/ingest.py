...
from app.core_workflows.faq.ingestion.config import (
    CHUNK_SIZE_WORDS,
    CHUNK_OVERLAP_WORDS,
    EMBEDDING_DIMENSION,
    PINECONE_CLOUD,
...
from app.core_workflows.faq.nodes.common import PINECONE_INDEX_NAME, PINECONE_NAMESPACE
...
def ingest_file(file_path: str):
    ...
    from app.core_workflows.faq.nodes.common import get_embedding_client
